...
import br.edu.ifpe.ui.swing.components.LabeledEnumComboBox;
import br.edu.ifpe.ui.swing.components.Page;
import br.edu.ifpe.ui.swing.components.TextField;
import br.edu.ifpe.core.domain.enums.Situation;
import br.edu.ifpe.core.domain.enums.Status;
...
public class CourseSituation extends Page implements ISubmittable {
    ...
    private final TextField cc = new TextField(10, "cc");
    private final TextField cpc = new TextField(10, "cpc");
    private final TextField enade = new TextField(10, "enade");
    private final TextField igc = new TextField(10, "igc");
